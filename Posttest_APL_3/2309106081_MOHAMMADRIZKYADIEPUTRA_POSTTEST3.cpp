...
// Deklarasi fungsi data
bool login(string namaBenar, string nimBenar);
void tambahData(Laptop data[], int &jumlahData, int max_data);
void tampilkanData(Laptop data[], int jumlahData);
void hapusData(Laptop data[], int &jumlahData);
int menu();

// Fungsi utama login Nama dan NIM serta Maks Data
int main()
{
    int max_data = 100;
...
// Prosedur untuk menghapus data penjualan laptop
void hapusData(Laptop data[], int &jumlahData)
{
    string merk;
